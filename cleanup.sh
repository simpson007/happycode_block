...
# Script for cleaning up blockly-specific files when merging blockly into happycode-blocks
# Removes files and directories that happycode-blocks doesn't want.
# Rachel Fenichel (fenichel@google.com)

# Note: 'ours' is happycode-blocks, 'theirs' is blockly.
...
empty_lines
echo Cleaning up a merge from Blockly to Happycode-Blocks...
...
# Happycode-blocks does not use generators
empty_lines
...
# Happycode-blocks has separate vertical and horizontal playgrounds and block
# rendering.
