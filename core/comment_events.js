 ...
 * @param {Blockly.WorkspaceComment | Blockly.HappycodeBlockComment} comment
 ...
 * @return {?(Blockly.WorkspaceComment | Blockly.HappycodeBlockComment)}
...
Blockly.Events.CommentMove = function(comment) {
   ...
   * location.
   * @type {?Blockly.WorkspaceComment | Blockly.HappycodeBlockComment}
   */
...
Blockly.Events.CommentMove.prototype.currentLocation_ = function() {
  ...
  var rtlAwareX;
  if (this.comment_ instanceof Blockly.HappycodeBlockComment) {
...
Blockly.Events.CommentMove.prototype.run = function(forward) {
  ...
  if (comment instanceof Blockly.HappycodeBlockComment) {
