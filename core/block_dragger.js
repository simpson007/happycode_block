...
Blockly.BlockDragger.prototype.endBlockDrag = function(e, currentDragDeltaXY) {
  ...
  // Happycode-specific: note possible illegal definition deletion for rollback below.
  ...
  if (isOutside) {
    ...
    // Reset a drag to outside of happycode-blocks
    setTimeout(function() {
      ws.undo();
    });
  }

  // Happycode-specific: roll back deletes that create call blocks with defines.
