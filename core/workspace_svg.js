 ...
 * In Happycode, appears as a pop-up next to the block when a reporter block is clicked.
...
Blockly.WorkspaceSvg.prototype.reportValue = function(id, value) {
  ...
  valueReportBox.innerHTML = Blockly.happycodeBlocksUtils.encodeEntities(value);
...
Blockly.WorkspaceSvg.prototype.pasteBlock_ = function(xmlBlock) {
  ...
  try {
    ...
    Blockly.happycodeBlocksUtils.changeObscuredShadowIds(block);
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function(e) {
  ...
  // Happycode-specific: don't count shadow blocks in delete count
  var deleteCount = 0;
