...
Blockly.Workspace.prototype.getTopComments = function(ordered) {
  ...
  if (ordered && comments.length > 1) {
    ...
    comments.sort(function(a, b) {
      var aXY = a instanceof Blockly.HappycodeBlockComment ? a.getXY() : a.getRelativeToSurfaceXY();
      var bXY = b instanceof Blockly.HappycodeBlockComment ? b.getXY() : b.getRelativeToSurfaceXY();
      return (aXY.y + offset * aXY.x) - (bXY.y + offset * bXY.x);
    });
  }
  return comments;
