...
Blockly.Procedures.sortProcedureMutations_ = function(mutations) {
  ...
  newMutations.sort(function(a, b) {
    ...
    return Blockly.happycodeBlocksUtils.compareStrings(procCodeA, procCodeB);
  });
...
Blockly.Procedures.procTupleComparator_ = function(ta, tb) {
  return Blockly.happycodeBlocksUtils.compareStrings(ta[0], tb[0]);
};
 ...
 * @param {string} name Name of procedure (procCode in happycode-blocks).
