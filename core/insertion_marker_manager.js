...
Blockly.InsertionMarkerManager = function(block) {
   ...
   * This is the happycode-blocks equivalent of connection highlighting.
   * @type {Blockly.BlockSvg}
   * @private
   */
   ...
   * This is part of the happycode-blocks equivalent of connection highlighting.
   * @type {Blockly.RenderedConnection}
   * @private
   */
 ...
 * Happycode-specific code, where "highlighting" applies to a block rather than
 * a connection.
 */
