...
Blockly.Connection.prototype.canConnectToPrevious_ = function(candidate) {
  ...
  // Happycode-specific behaviour: can connect to the first statement input of a
 ...
 * Used in happycode-blocks to draw unoccupied inputs.
