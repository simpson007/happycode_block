 ...
 * @author kchadha@happycode.mit.edu (Karishma Chadha)
 */
'use strict';

goog.provide('Blockly.HappycodeBubble');
...
/**
 * Class for Happycode comment UI bubble.
 * @param {!Blockly.HappycodeBlockComment} comment The comment this bubble belongs
 *     to.
 ...
 * @constructor
 */
Blockly.HappycodeBubble = function(comment, workspace, content, anchorXY,
    bubbleWidth, bubbleHeight, bubbleX, bubbleY, minimized) {

  // Needed for Events
  /**
   * The comment this bubble belongs to.
   * @type {Blockly.HappycodeBlockComment}
   * @package
   */
  ...
  if (!bubbleWidth || !bubbleHeight) {
    ...
    bubbleWidth = bBox.width + 2 * Blockly.HappycodeBubble.BORDER_WIDTH;
    bubbleHeight = bBox.height + 2 * Blockly.HappycodeBubble.BORDER_WIDTH;
  }
...
goog.inherits(Blockly.HappycodeBubble, Blockly.Bubble);

/**
 * Width of the border around the bubble.
 * @package
 */
Blockly.HappycodeBubble.BORDER_WIDTH = 1;
 ...
 * @private
 */
Blockly.HappycodeBubble.LINE_THICKNESS = 1;

/**
 * The height of the comment top bar.
 * @package
 */
Blockly.HappycodeBubble.TOP_BAR_HEIGHT = 32;

/**
 * The size of the minimize arrow icon in the comment top bar.
 * @private
 */
Blockly.HappycodeBubble.MINIMIZE_ICON_SIZE = 32;

/**
 * The size of the delete icon in the comment top bar.
 * @private
 */
Blockly.HappycodeBubble.DELETE_ICON_SIZE = 32;

/**
 * The inset for the top bar icons.
 * @private
 */
Blockly.HappycodeBubble.TOP_BAR_ICON_INSET = 0;
 ...
 * @private
 */
Blockly.HappycodeBubble.RESIZE_SIZE = 16;
 ...
 * @private
 */
Blockly.HappycodeBubble.RESIZE_CORNER_PAD = 4;
 ...
 * @private
 */
Blockly.HappycodeBubble.RESIZE_OUTER_PAD = 8;
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.createDom_ = function(content, hasResize, minimized) {
  ...
  this.bubbleBack_ = Blockly.utils.createSvgElement('rect',
      {
        'class': 'blocklyDraggable happycodeCommentRect',
        'x': 0,
        'y': 0,
        'rx': 4 * Blockly.HappycodeBubble.BORDER_WIDTH,
        'ry': 4 * Blockly.HappycodeBubble.BORDER_WIDTH
      },
      this.bubbleGroup_);
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.createCommentTopBar_ = function() {
  this.commentTopBar_ = Blockly.utils.createSvgElement('rect',
      {
        'class': 'blocklyDraggable happycodeCommentTopBar',
        'rx': Blockly.HappycodeBubble.BORDER_WIDTH,
        'ry': Blockly.HappycodeBubble.BORDER_WIDTH,
        'height': Blockly.HappycodeBubble.TOP_BAR_HEIGHT
      }, this.bubbleGroup_);
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.createTopBarIcons_ = function() {
  var topBarMiddleY = (Blockly.HappycodeBubble.TOP_BAR_HEIGHT / 2) +
      Blockly.HappycodeBubble.BORDER_WIDTH;

  // Minimize Toggle Icon in Comment Top Bar
  var xInset = Blockly.HappycodeBubble.TOP_BAR_ICON_INSET;
  this.minimizeArrow_ = Blockly.utils.createSvgElement('image',
      {
        'x': xInset,
        'y': topBarMiddleY - Blockly.HappycodeBubble.MINIMIZE_ICON_SIZE / 2,
        'width': Blockly.HappycodeBubble.MINIMIZE_ICON_SIZE,
        'height': Blockly.HappycodeBubble.MINIMIZE_ICON_SIZE
      }, this.bubbleGroup_);
  ...
  this.deleteIcon_ = Blockly.utils.createSvgElement('image',
      {
        'x': xInset,
        'y': topBarMiddleY - Blockly.HappycodeBubble.DELETE_ICON_SIZE / 2,
        'width': Blockly.HappycodeBubble.DELETE_ICON_SIZE,
        'height': Blockly.HappycodeBubble.DELETE_ICON_SIZE
      }, this.bubbleGroup_);
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.createTopBarLabel_ = function() {
  this.topBarLabel_ = Blockly.utils.createSvgElement('text',
      {
        'class': 'happycodeCommentText',
        'x': this.width_ / 2,
        'y': (Blockly.HappycodeBubble.TOP_BAR_HEIGHT / 2) + Blockly.HappycodeBubble.BORDER_WIDTH,
        'text-anchor': 'middle',
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.createResizeHandle_ = function() {
  this.resizeGroup_ = Blockly.utils.createSvgElement('g',
      {'class': this.workspace_.RTL ?
                'happycodeCommentResizeSW' : 'happycodeCommentResizeSE'},
      this.bubbleGroup_);
  var resizeSize = Blockly.HappycodeBubble.RESIZE_SIZE;
  var outerPad = Blockly.HappycodeBubble.RESIZE_OUTER_PAD;
  var cornerPad = Blockly.HappycodeBubble.RESIZE_CORNER_PAD;
...
/**
  ...
  * @private
  */
Blockly.HappycodeBubble.prototype.showContextMenu_ = function(e) {
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.minimizeArrowMouseDown_ = function(e) {
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.minimizeArrowMouseOut_ = function(_e) {
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.minimizeArrowMouseUp_ = function(e) {
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.deleteMouseDown_ = function(e) {
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.deleteMouseOut_ = function(_e) {
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.deleteMouseUp_ = function(e) {
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.resizeMouseDown_ = function(e) {
  this.resizeStartSize_ = {width: this.width_, height: this.height_};
  this.workspace_.setResizesEnabled(false);
  Blockly.HappycodeBubble.superClass_.resizeMouseDown_.call(this, e);
};
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.resizeMouseUp_ = function(_e) {
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.setMinimized = function(minimize, labelText) {
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.registerMinimizeToggleEvent = function(callback) {
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.registerDeleteEvent = function(callback) {
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.registerContextMenuCallback = function(callback) {
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.setAnchorLocation = function(xy) {
  this.anchorXY_ = xy;
  if (this.rendered_) {
    this.positionBubble_();
  }
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.moveTo = function(x, y) {
  Blockly.HappycodeBubble.superClass_.moveTo.call(this, x, y);
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.setBubbleSize = function(width, height) {
  var doubleBorderWidth = 2 * Blockly.HappycodeBubble.BORDER_WIDTH;
  // Minimum size of a bubble.
  width = Math.max(width, doubleBorderWidth + 50);
  height = Math.max(height, Blockly.HappycodeBubble.TOP_BAR_HEIGHT);
  this.width_ = width;
  this.height_ = height;
  this.bubbleBack_.setAttribute('width', width);
  this.bubbleBack_.setAttribute('height', height);
  this.commentTopBar_.setAttribute('width', width);
  this.commentTopBar_.setAttribute('height', Blockly.HappycodeBubble.TOP_BAR_HEIGHT);
  if (this.workspace_.RTL) {
    this.minimizeArrow_.setAttribute('x', width -
        (Blockly.HappycodeBubble.MINIMIZE_ICON_SIZE) -
        Blockly.HappycodeBubble.TOP_BAR_ICON_INSET);
  } else {
    this.deleteIcon_.setAttribute('x', width -
        Blockly.HappycodeBubble.DELETE_ICON_SIZE -
        Blockly.HappycodeBubble.TOP_BAR_ICON_INSET);
  }
  if (this.resizeGroup_) {
    var resizeSize = Blockly.HappycodeBubble.RESIZE_SIZE;
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.renderArrow_ = function() {
  // Find the relative coordinates of the top bar center of the bubble.
  var relBubbleX = this.width_ / 2;
  var relBubbleY = Blockly.HappycodeBubble.TOP_BAR_HEIGHT / 2;
  ...
  if (relBubbleX != relAnchorX || relBubbleY != relAnchorY) {
    ...
    this.bubbleArrow_.setAttribute('stroke-width', Blockly.HappycodeBubble.LINE_THICKNESS);
  }
};
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.setColour = function(hexColour) {
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.moveDuringDrag = function(dragSurface, newLoc) {
  if (dragSurface) {
 ...
 * @private
 */
Blockly.HappycodeBubble.prototype.updatePosition_ = function(x, y) {
 ...
 * @package
 */
Blockly.HappycodeBubble.prototype.dispose = function() {
  Blockly.HappycodeBubble.superClass_.dispose.call(this);
