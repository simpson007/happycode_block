...
Blockly.FieldColourSlider.prototype.createLabelDom_ = function(labelText) {
  ...
  labelContainer.setAttribute('class', 'happycodeColourPickerLabel');
  var readout = document.createElement('span');
  readout.setAttribute('class', 'happycodeColourPickerReadout');
  var label = document.createElement('span');
  label.setAttribute('class', 'happycodeColourPickerLabelText');
...
Blockly.FieldColourSlider.prototype.showEditor_ = function() {
  ...
  if (Blockly.FieldColourSlider.activateEyedropper_) {
    ...
    button.setAttribute('class', 'happycodeEyedropper');
