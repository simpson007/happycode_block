...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '.happycodeCommentForeignObject {',
    'position: relative;',
  '}',

  '.happycodeCommentBody {',
    'background-color: #fef49c;',
    'border-radius: 4px;',
  '}',

  '.happycodeCommentRect {',
    'fill: #fef49c;',
  '}',

  '.happycodeCommentTarget {',
    'fill: transparent;',
  '}',

  '.happycodeWorkspaceCommentBorder {',
    'stroke: #bcA903;',
    'stroke-width: 1px;',
  '}',

  '.happycodeCommentTargetFocused {',
    'fill: none;',
  '}',

  '.happycodeCommentTopBar {',
    'fill: #000000;',
    'fill-opacity: 0.1',
  '}',

  '.happycodeCommentText {',
    'font-family: "Helvetica Neue", Helvetica, sans-serif;',
    'font-size: 12pt;',
    'font-weight: 400;',
  '}',

  '.happycodeCommentTextarea {',
    'background-color: #fef49c;',
    'border: 0;',
    'outline: 0;',
    'padding: 0;',
  ...
  '.happycodeCommentTextarea::placeholder {',
    'color: rgba(0,0,0,0.5);',
    'font-style: italic;',
  '}',

  '.happycodeCommentResizeSE {',
    'cursor: se-resize;',
    'fill: transparent;',
  '}',

  '.happycodeCommentResizeSW {',
    'cursor: sw-resize;',
    'fill: transparent;',
  '}',
  ...
  '.happycodeColourPickerLabelText {',
    'font-weight: bold;',
  '}',

  '.happycodeColourPickerReadout {',
    'margin-left: 10px;',
  '}',

  '.happycodeMatrixButtonDiv {',
    'width: 50%;',
    'text-align: center;',
    'float: left;',
  '}',

  '.happycodeNotePickerKeyLabel {',
    'font-family: "Helvetica Neue", Helvetica, sans-serif;',
    'font-size: 0.75rem;',
    'fill: $colour_text;',
    'pointer-events: none;',
  ...
  '.happycodeCategoryMenuHorizontal {',
    'width: 100%;',
    'height: 50px;',
    'background: $colour_toolbox;',
    'color: $colour_toolboxText;',
  ...
  '.happycodeCategoryMenuHorizontal .happycodeCategoryMenuRow {',
    'float: left;',
    'margin: 3px;',
  '}',

  '.happycodeCategoryMenuRow {',
  '}',

  '.happycodeCategoryMenuItem {',
    'padding: 0.375rem 0px;',
    'cursor: pointer;',
    'text-align: center;',
  '}',

  '.happycodeCategoryMenuHorizontal .happycodeCategoryMenuItem {',
    'padding: 6px 5px;',
  '}',

  '.happycodeCategoryMenuItem.categorySelected {',
    'background: $colour_toolboxSelected;',
  '}',

  '.happycodeCategoryItemBubble {',
    'width: 1.25rem;',
    'height: 1.25rem;',
    'border: 1px solid;',
    'border-radius: 100%;',
  ...
  '.happycodeCategoryMenuItem:hover {',
