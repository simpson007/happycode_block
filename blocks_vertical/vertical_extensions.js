...
/**
 * @fileoverview Extensions for vertical blocks in happycode-blocks.
 * The following extensions can be used to describe a block in Happycode terms.
...
goog.provide('Blockly.HappycodeBlocks.VerticalExtensions');
 ...
 *     category.
 */
Blockly.HappycodeBlocks.VerticalExtensions.colourHelper = function(category) {
 ...
 */
Blockly.HappycodeBlocks.VerticalExtensions.COLOUR_TEXTFIELD = function() {
 ...
 * @readonly
 */
Blockly.HappycodeBlocks.VerticalExtensions.SHAPE_STATEMENT = function() {
 ...
 * @readonly
 */
Blockly.HappycodeBlocks.VerticalExtensions.SHAPE_HAT = function() {
  this.setInputsInline(true);
  this.setNextStatement(true, null);
};
 ...
 * @readonly
 */
Blockly.HappycodeBlocks.VerticalExtensions.SHAPE_END = function() {
  this.setInputsInline(true);
  this.setPreviousStatement(true, null);
};

/**
 * Extension to make represent a number reporter in Happycode-Blocks.
 * That means the block has inline inputs, a round output shape, and a 'Number'
 * output type.
 * @this {Blockly.Block}
 * @readonly
 */
Blockly.HappycodeBlocks.VerticalExtensions.OUTPUT_NUMBER = function() {
  this.setInputsInline(true);
...
/**
 * Extension to make represent a string reporter in Happycode-Blocks.
 * That means the block has inline inputs, a round output shape, and a 'String'
 * output type.
 * @this {Blockly.Block}
 * @readonly
 */
Blockly.HappycodeBlocks.VerticalExtensions.OUTPUT_STRING = function() {
  this.setInputsInline(true);
  this.setOutputShape(Blockly.OUTPUT_SHAPE_ROUND);
...
/**
 * Extension to make represent a boolean reporter in Happycode-Blocks.
 * That means the block has inline inputs, a round output shape, and a 'Boolean'
 * output type.
 * @this {Blockly.Block}
 * @readonly
 */
Blockly.HappycodeBlocks.VerticalExtensions.OUTPUT_BOOLEAN = function() {
  this.setInputsInline(true);
 ...
 * @readonly
 */
Blockly.HappycodeBlocks.VerticalExtensions.PROCEDURE_DEF_CONTEXTMENU = {
  /**
 ...
 * @readonly
 */
Blockly.HappycodeBlocks.VerticalExtensions.PROCEDURE_CALL_CONTEXTMENU = {
  /**
...
/**
 * Register all extensions for happycode-blocks.
 * @package
 */
Blockly.HappycodeBlocks.VerticalExtensions.registerAll = function() {
  var categoryNames =
  ...
  for (var i = 0; i < categoryNames.length; i++) {
    ...
    Blockly.Extensions.register('colours_' + name,
        Blockly.HappycodeBlocks.VerticalExtensions.colourHelper(name));
  }

  // Text fields transcend categories.
  Blockly.Extensions.register('colours_textfield',
      Blockly.HappycodeBlocks.VerticalExtensions.COLOUR_TEXTFIELD);

  // Register extensions for common block shapes.
  Blockly.Extensions.register('shape_statement',
      Blockly.HappycodeBlocks.VerticalExtensions.SHAPE_STATEMENT);
  Blockly.Extensions.register('shape_hat',
      Blockly.HappycodeBlocks.VerticalExtensions.SHAPE_HAT);
  Blockly.Extensions.register('shape_end',
      Blockly.HappycodeBlocks.VerticalExtensions.SHAPE_END);

  // Output shapes and types are related.
  Blockly.Extensions.register('output_number',
      Blockly.HappycodeBlocks.VerticalExtensions.OUTPUT_NUMBER);
  Blockly.Extensions.register('output_string',
      Blockly.HappycodeBlocks.VerticalExtensions.OUTPUT_STRING);
  Blockly.Extensions.register('output_boolean',
      Blockly.HappycodeBlocks.VerticalExtensions.OUTPUT_BOOLEAN);
