...
Blockly.Blocks['extension_pen_down'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "extensions": ["colours_more", "shape_statement", "happycode_extension"]
    });
  }
};
...
Blockly.Blocks['extension_wedo_hat'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.more,
      "extensions": ["colours_more", "shape_hat", "happycode_extension"]
    });
  }
};
...
Blockly.Blocks['extension_wedo_boolean'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.more,
      "extensions": ["colours_more", "output_boolean", "happycode_extension"]
    });
  }
};
...
Blockly.Blocks['extension_wedo_tilt_reporter'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "category": Blockly.Categories.more,
      "extensions": ["colours_more", "output_number", "happycode_extension"]
    });
  }
};
...
Blockly.Blocks['extension_microbit_display'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "extensions": ["colours_pen", "shape_statement", "happycode_extension"]
    });
  }
};
