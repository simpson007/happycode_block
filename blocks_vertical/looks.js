...
Blockly.Blocks['looks_hideallsprites'] = {
   ...
   * obsolete block that is implemented for compatibility with Happycode 2.0
   * projects.
   * @this Blockly.Block
   */
  init: function() {
...
Blockly.Blocks['looks_changestretchby'] = {
   ...
   * obsolete block that is implemented for compatibility with Happycode 1.4
   * projects as well as 2.0 projects that still have the block.
   * The "stretch" blocks were introduced in very early versions of Happycode,
   * but their functionality was removed shortly later. They still appeared
   * correctly up until (and including) Happycode 1.4 - as "change stretch by"
   * and "set stretch to" - but were removed altogether in Happycode 2.0, and
   * displayed as red "undefined" blocks. Some Happycode projects still contain
...
Blockly.Blocks['looks_setstretchto'] = {
   ...
   * block that is implemented for compatibility with Happycode 1.4 projects
