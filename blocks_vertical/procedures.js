...
/**
 * @fileoverview Procedure blocks for Happycode.
 */
'use strict';

goog.provide('Blockly.HappycodeBlocks.ProcedureUtils');

goog.require('Blockly.Blocks');
goog.require('Blockly.Colours');
goog.require('Blockly.constants');
goog.require('Blockly.HappycodeBlocks.VerticalExtensions');
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.callerMutationToDom = function() {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.callerDomToMutation = function(xmlElement) {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.definitionMutationToDom = function(
    opt_generateShadows) {
  var container = document.createElement('mutation');
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.definitionDomToMutation = function(xmlElement) {
  this.procCode_ = xmlElement.getAttribute('proccode');
  this.warp_ = JSON.parse(xmlElement.getAttribute('warp'));
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.getProcCode = function() {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.updateDisplay_ = function() {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.disconnectOldBlocks_ = function() {
  // Remove old stuff
  var connectionMap = {};
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.removeAllInputs_ = function() {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.createAllInputs_ = function(connectionMap) {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.deleteShadows_ = function(connectionMap) {
 ...
 * @private
 */
Blockly.HappycodeBlocks.ProcedureUtils.addLabelField_ = function(text) {
 ...
 * @private
 */
Blockly.HappycodeBlocks.ProcedureUtils.addLabelEditor_ = function(text) {
  if (text) {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.buildShadowDom_ = function(type) {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.attachShadow_ = function(input,
    argumentType) {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.createArgumentReporter_ = function(
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.populateArgumentOnCaller_ = function(type,
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.populateArgumentOnPrototype_ = function(
  ...
  var oldTypeMatches =
    Blockly.HappycodeBlocks.ProcedureUtils.checkOldTypeMatches_(oldBlock, type);
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.populateArgumentOnDeclaration_ = function(
    type, index, connectionMap, id, input) {
 ...
 */
Blockly.HappycodeBlocks.ProcedureUtils.checkOldTypeMatches_ = function(oldBlock,
    type) {
  if (!oldBlock) {
    return false;
  }
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.createArgumentEditor_ = function(
    argumentType, displayName) {
  Blockly.Events.disable();
  try {
    if (argumentType == 'n' || argumentType == 's') {
 ...
 * and their text.
 */
Blockly.HappycodeBlocks.ProcedureUtils.updateDeclarationProcCode_ = function() {
  this.procCode_ = '';
  this.displayNames_ = [];
  this.argumentIds_ = [];
 ...
 * @private
 */
Blockly.HappycodeBlocks.ProcedureUtils.focusLastEditor_ = function() {
 ...
 * @public
 */
Blockly.HappycodeBlocks.ProcedureUtils.addLabelExternal = function() {
 ...
 * @public
 */
Blockly.HappycodeBlocks.ProcedureUtils.addBooleanExternal = function() {
  Blockly.WidgetDiv.hide(true);
 ...
 * @public
 */
Blockly.HappycodeBlocks.ProcedureUtils.addStringNumberExternal = function() {
  Blockly.WidgetDiv.hide(true);
 ...
 * @public
 */
Blockly.HappycodeBlocks.ProcedureUtils.getWarp = function() {
  return this.warp_;
};
 ...
 * @public
 */
Blockly.HappycodeBlocks.ProcedureUtils.setWarp = function(warp) {
  this.warp_ = warp;
};
 ...
 * @public
 */
Blockly.HappycodeBlocks.ProcedureUtils.removeFieldCallback = function(field) {
 ...
 * @public
 */
Blockly.HappycodeBlocks.ProcedureUtils.removeArgumentCallback_ = function(
    field) {
 ...
 * @this Blockly.Block
 */
Blockly.HappycodeBlocks.ProcedureUtils.updateArgumentReporterNames_ = function(prevArgIds, prevDisplayNames) {
  var nameChanges = [];
  var argReporters = [];
...
Blockly.Blocks['procedures_call'] = {
  ...
  // Shared.
  getProcCode: Blockly.HappycodeBlocks.ProcedureUtils.getProcCode,
  removeAllInputs_: Blockly.HappycodeBlocks.ProcedureUtils.removeAllInputs_,
  disconnectOldBlocks_: Blockly.HappycodeBlocks.ProcedureUtils.disconnectOldBlocks_,
  deleteShadows_: Blockly.HappycodeBlocks.ProcedureUtils.deleteShadows_,
  createAllInputs_: Blockly.HappycodeBlocks.ProcedureUtils.createAllInputs_,
  updateDisplay_: Blockly.HappycodeBlocks.ProcedureUtils.updateDisplay_,

  // Exist on all three blocks, but have different implementations.
  mutationToDom: Blockly.HappycodeBlocks.ProcedureUtils.callerMutationToDom,
  domToMutation: Blockly.HappycodeBlocks.ProcedureUtils.callerDomToMutation,
  populateArgument_: Blockly.HappycodeBlocks.ProcedureUtils.populateArgumentOnCaller_,
  addProcedureLabel_: Blockly.HappycodeBlocks.ProcedureUtils.addLabelField_,

  // Only exists on the external caller.
  attachShadow_: Blockly.HappycodeBlocks.ProcedureUtils.attachShadow_,
  buildShadowDom_: Blockly.HappycodeBlocks.ProcedureUtils.buildShadowDom_
};
...
Blockly.Blocks['procedures_prototype'] = {
  ...
  // Exist on all three blocks, but have different implementations.
  mutationToDom: Blockly.HappycodeBlocks.ProcedureUtils.definitionMutationToDom,
  domToMutation: Blockly.HappycodeBlocks.ProcedureUtils.definitionDomToMutation,
  populateArgument_: Blockly.HappycodeBlocks.ProcedureUtils.populateArgumentOnPrototype_,
  addProcedureLabel_: Blockly.HappycodeBlocks.ProcedureUtils.addLabelField_,

  // Only exists on procedures_prototype.
  createArgumentReporter_: Blockly.HappycodeBlocks.ProcedureUtils.createArgumentReporter_,
  updateArgumentReporterNames_: Blockly.HappycodeBlocks.ProcedureUtils.updateArgumentReporterNames_
};
...
Blockly.Blocks['procedures_declaration'] = {
  ...
  mutationToDom: Blockly.HappycodeBlocks.ProcedureUtils.definitionMutationToDom,
  domToMutation: Blockly.HappycodeBlocks.ProcedureUtils.definitionDomToMutation,
  populateArgument_: Blockly.HappycodeBlocks.ProcedureUtils.populateArgumentOnDeclaration_,
  addProcedureLabel_: Blockly.HappycodeBlocks.ProcedureUtils.addLabelEditor_,

  // Exist on declaration and arguments editors, with different implementations.
  removeFieldCallback: Blockly.HappycodeBlocks.ProcedureUtils.removeFieldCallback,

  // Only exist on procedures_declaration.
  createArgumentEditor_: Blockly.HappycodeBlocks.ProcedureUtils.createArgumentEditor_,
  focusLastEditor_: Blockly.HappycodeBlocks.ProcedureUtils.focusLastEditor_,
  getWarp: Blockly.HappycodeBlocks.ProcedureUtils.getWarp,
  setWarp: Blockly.HappycodeBlocks.ProcedureUtils.setWarp,
  addLabelExternal: Blockly.HappycodeBlocks.ProcedureUtils.addLabelExternal,
  addBooleanExternal: Blockly.HappycodeBlocks.ProcedureUtils.addBooleanExternal,
  addStringNumberExternal: Blockly.HappycodeBlocks.ProcedureUtils.addStringNumberExternal,
  onChangeFn: Blockly.HappycodeBlocks.ProcedureUtils.updateDeclarationProcCode_
};
...
Blockly.Blocks['argument_editor_boolean'] = {
  ...
  // Exist on declaration and arguments editors, with different implementations.
  removeFieldCallback: Blockly.HappycodeBlocks.ProcedureUtils.removeArgumentCallback_
};
