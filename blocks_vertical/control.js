...
Blockly.Blocks['control_for_each'] = {
   ...
   * compatibility with Happycode 2.0 projects.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
...
Blockly.Blocks['control_get_counter'] = {
   ...
   * implemented for compatibility with Happycode 2.0 projects.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
...
Blockly.Blocks['control_all_at_once'] = {
   ...
   * implemented for compatibility with Happycode 2.0 projects. Note that
   ...
   * Happycode 2.0 spec for this block is "warpSpeed", but the label shows
   * "all at once".
   * @this Blockly.Block
   */
  init: function() {
